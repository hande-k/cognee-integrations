...
Use `Cognee: Search Connected Sources` for questions spanning connected sources. Provide a question and an
...
The command asks for the question and optional source hint, then opens the structured evidence in an editor tab. Existing project-memory commands keep their scope.
